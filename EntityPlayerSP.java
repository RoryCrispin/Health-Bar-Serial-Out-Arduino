...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void setHealth(float par1)
    {
        ...
        System.out.println("HEALTH: " + String.valueOf(par1) + "var2 = " + String.valueOf(var2));
        arduinoOutput(par1);
        if (var2 == 5.0){
        	this.damageEntity(DamageSource.generic, 10);
    ...
    public void arduinoOutput(float par1){
    	...
    	healthPercent = (int)par1;
    	healthPercent= healthPercent/2;
        try {
			Process p = r.exec("python /Users/Rozz/ser.py " + String.valueOf(healthPercent));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
